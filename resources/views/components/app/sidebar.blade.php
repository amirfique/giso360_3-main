<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0"
            ...
            <span class="font-weight-bold text-lg">GISO 360</span>
        </a>
    </div>
    <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('dashboard') || is_current_route('admin.dashboard') ? 'active' : '' }}"
                    ...
                    href="{{ route('presentation-schedules.index') }}">
                        <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                            <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                                ...
                                <g id="presentation-schedule" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g id="template" transform="translate(12.000000, 12.000000)" fill="#FFFFFF" fill-rule="nonzero">
                                        <path class="color-foreground"
                                            d="M0,1.71428571 C0,0.76752 0.76752,0 1.71428571,0 L22.2857143,0 C23.2325143,0 24,0.76752 24,1.71428571 L24,5.14285714 C24,6.08962286 23.2325143,6.85714286 22.2857143,6.85714286 L1.71428571,6.85714286 C0.76752,6.85714286 0,6.08962286 0,5.14285714 L0,1.71428571 Z"
                                            id="Path"></path>
                                        <path class="color-background"
                                            d="M18,10 L6,10 C5.44771525,10 5,10.4477153 5,11 L5,12 C5,12.5522847 5.44771525,13 6,13 L18,13 C18.5522847,13 19,12.5522847 19,12 L19,11 C19,10.4477153 18.5522847,10 18,10 Z"
                                            id="Path"></path>
                                        <path class="color-background"
                                            d="M16,14 L8,14 C7.44771525,14 7,14.4477153 7,15 L7,16 C7,16.5522847 7.44771525,17 8,17 L16,17 C16.5522847,17 17,16.5522847 17,16 L17,15 C17,14.4477153 16.5522847,14 16,14 Z"
                                            id="Path"></path>
                                        <path class="color-background"
                                            d="M14,18 L10,18 C9.44771525,18 9,18.4477153 9,19 L9,20 C9,20.5522847 9.44771525,21 10,21 L14,21 C14.5522847,21 15,20.5522847 15,20 L15,19 C15,18.4477153 14.5522847,18 14,18 Z"
                                            id="Path"></path>
                                    </g>
                                </g>
                            </svg>
                        </div>
                        <span class="nav-link-text ms-1">Presentation Schedule</span>
                    </a>
                </li>
                    ...
                    href="{{ route('admin.presentation-schedules') }}">
                        <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                            <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                                ...
                                <g id="manage-schedule" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g id="template" transform="translate(12.000000, 12.000000)" fill="#FFFFFF" fill-rule="nonzero">
                                        <path class="color-foreground"
                                            d="M0,1.71428571 C0,0.76752 0.76752,0 1.71428571,0 L22.2857143,0 C23.2325143,0 24,0.76752 24,1.71428571 L24,5.14285714 C24,6.08962286 23.2325143,6.85714286 22.2857143,6.85714286 L1.71428571,6.85714286 C0.76752,6.85714286 0,6.08962286 0,5.14285714 L0,1.71428571 Z"
                                            id="Path"></path>
            ...
            {{-- Laravel Examples Section (For Both) --}}
            <li class="nav-item mt-2">
                <div class="d-flex align-items-center nav-link">
                    ...
                    <span class="font-weight-normal text-md ms-2">
                        {{ Auth::user()->role === 'admin' ? 'Examples' : 'Laravel Examples' }}
                    </span>
                </div>
            </li>
