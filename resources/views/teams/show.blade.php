                    ...
                    <div class="card-header border-bottom pb-0">
                        <div class="d-sm-flex align-items-center">
                            ...
                            <div class="ms-auto d-flex">
                                ...
                                <button type="button" class="btn btn-sm btn-dark btn-icon d-flex align-items-center me-2" data-bs-toggle="modal" data-bs-target="#addMemberModal">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ $member->profile_photo_url ?? '../assets/img/team-2.jpg' }}" class="avatar avatar-sm rounded-circle me-2" alt="{{ $member->name }}">
                                                </div>
                                        ...
                                        <td class="align-middle">
                                            <!-- Empty cell since we've moved the role change to the Role column -->
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
            ...
            <div class="col-12">
                <div class="card border shadow-xs mb-4">
                    <div class="card-header border-bottom pb-0">
                        <div class="d-sm-flex align-items-center">
                            <div>
                                <h6 class="font-weight-semibold text-lg mb-0">Team Documents & Finance</h6>
                                <p class="text-sm">Manage proposals, reports and financial tracking</p>
                            </div>
                        </div>
                        
                        <!-- Tab Navigation -->
                        <ul class="nav nav-tabs mt-3" id="documentsTab" role="tablist">
                        ...
                        <div class="tab-content" id="documentsTabContent">
                            ...
                            <div class="tab-pane fade show active" id="proposals" role="tabpanel" aria-labelledby="proposals-tab">
                                <div class="border-bottom py-3 px-3 d-sm-flex align-items-center">
                                    ...
                                    <div class="input-group w-sm-25 ms-3">
                                        <span class="input-group-text text-body">
                            ...
                            <div class="tab-pane fade" id="finance" role="tabpanel" aria-labelledby="finance-tab">
                                <div class="p-4 text-center">
                                    <div class="mb-4">
                                        ...
                                        <h5 class="font-weight-semibold">Finance Management</h5>
                                        <p class="text-muted">Manage team expenses and financial tracking</p>
                                    </div>
                                    <a href="{{ route('teams.finance', $team) }}" class="btn btn-dark btn-lg">
